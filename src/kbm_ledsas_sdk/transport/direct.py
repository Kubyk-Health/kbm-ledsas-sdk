...
class DirectTransport(Transport):
    ...
    def __init__(
        ...
        # Operational counters. L3: split into two so an ops dashboard
    ...
    async def send_status(self, status: Status) -> None:
        ...
        In Direct mode, if the reply_to exchange doesn't exist, the status
        is logged and skipped (no exception). This is useful for testing
        without setting up response infrastructure.
    ...
    async def stop(self) -> None:
        ...
        # Close Azure Blob client. L7: don't re-log "Azure Blob client
